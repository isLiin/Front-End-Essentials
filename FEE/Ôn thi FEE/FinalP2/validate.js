$(document).ready(function () {
    ...
    isNgayXuatHoaHon = function (selector) {
    ...
    isAddress = function (selector) {
        ...
        if ($(selector).val() == "") {
            $(selector).addClass("is-invalid");
            $(selector).next().html("Yêu cầu nhập địa chỉ!!!");
            return false
        } else if (!regex.test($(selector).val())) {
            $(selector).addClass("is-invalid");
            $(selector).next().html("Bạn nhập sai!");
    ...
    isNote = function (selector) {
        // let regex = /^(C)[a-zA-z]+$/;
        let regex = /^[ a-zA-Z]+$/;
        if ($(selector).val() == "") {
            $(selector).addClass("is-invalid");
            $(selector).next().html("Yêu cầu nhập ghi chú!!!");
            return false
        } else if (!regex.test($(selector).val())) {
            $(selector).addClass("is-invalid");
            $(selector).next().html("Bạn nhập sai!");
    ...
    isItem = function (selector) {
        // let regex = /^(C)[a-zA-z]+$/;
        let regex = /^[ a-zA-Z]+$/;
        if ($(selector).val() == "") {
            $(selector).addClass("is-invalid");
            $(selector).next().html("Yêu cầu nhập tên hàng hoá!!!");
            return false
        } else if (!regex.test($(selector).val())) {
            $(selector).addClass("is-invalid");
            $(selector).next().html("Bạn nhập sai!");
    ...
    isQuantity = function (selector) {
        // let regex = /^[1-9]{1}[0-9]+$/;
        if ($(selector).val() <= 0) {
            console.log("Sai ne");
            $(selector).addClass("is-invalid");
            $(selector).next().html("Số lượng không hợp lệ");
            return false;
        } else {
            $(selector).removeClass("is-invalid");
            return true
    ...
    isPrice = function (selector) {
        // let regex = /^[1-9]{1}[0-9]+$/;
        if ($(selector).val() <= 0) {
            console.log("Sai ne");
            $(selector).addClass("is-invalid");
            $(selector).next().html("Đơn giá không hợp lệ");
            return false;
        }  else {
            $(selector).removeClass("is-invalid");
            return true
    ...
    isCMND = function (selector, i) {
        ...
        if ($(selector).val() == "") {
            ...
            $(selector).addClass("is-invalid");
            $(selector).next().html("Ban nhap chua đúng số CMND");
            return false;
        } else {
            $(selector).removeClass("is-invalid");
            return true
    ...
    // console.log(new Date() > new Date('2022'))
    // validate ngày nhập không được nhỏ hơn năm hiện tại
    lonHonNamHTandNgayKhac = function (selector, selector2) {
    ...
    // Validate Email
    ischeckbox = function (selector, msg) {
        if (!$(selector).prop('checked')) {
            $(selector).addClass("is-invalid");
            $(selector).next().html(msg + ":___Ban chua kich chon truong nay");
            return false;
        } else {
            $(selector).removeClass("is-invalid");
